...
tf.app.flags.DEFINE_string('checkpoint', '../data/SqueezeSeg16/model.ckpt-41500', """Path to the model parameter file.""")
# tf.app.flags.DEFINE_string('checkpoint', "/home/iiarroyo/catkin_ws/src/squeezeseg-vlp16/log/log16_G_CRF/train/model.ckpt-16500", """Path to the model parameter file.""")
tf.app.flags.DEFINE_string('input_path', '/home/iiarroyo/Documents/sparse-segmentation/data/sample/downsampled/vlp16m/lidar_2d/*', """Input lidar scan to be detected.""")
# tf.app.flags.DEFINE_string('input_path', '/home/iiarroyo/catkin_ws/src/squeezeseg-vlp16/data/vlp16_npy/*', """Input lidar scan to be detected.""")
# tf.app.flags.DEFINE_string('input_path', '/home/iiarroyo/Documents/bags_estancia/npybags/*', """Input lidar scan to be detected.""")
