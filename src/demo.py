...
tf.app.flags.DEFINE_string(
        'checkpoint', './data/SqueezeSeg16/model.ckpt-41500',
        """Path to the model parameter file.""")
tf.app.flags.DEFINE_string(
        'input_path', '/home/iiarroyo/Documents/sparse-segmentation/data/sample/downsampled/vlp16m/demo/*',
...
def detect():
  ...
  with tf.Graph().as_default():
    mc = kitti_squeezeSeg16_config_ext()
